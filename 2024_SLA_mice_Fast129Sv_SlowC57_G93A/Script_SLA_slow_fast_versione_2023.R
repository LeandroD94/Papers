...
dir.create("Results/PS/PICRUSt2_LEfSe/only_over_3")
...
for( x in dir("QIIME/PICRUST2_LEFSE/")[grepl("Result_",dir("QIIME/PICRUST2_LEFSE/"))] ) {
  ...
  if( length(Significative_functions_LEFSE[abs(Significative_functions_LEFSE$logLDA_score)>3, ][[1]]) >0 ){
    ...
    ggsave(filename = paste0("Results/PS/PICRUSt2_LEfSe/only_over_3/BarPlot_",file_name,"_KEGG_only_over3.png"), width = 7, height = 3, dpi = 300)
  }
