...
# programs required: conda, qiime2-amplicon-2024.2
...
# these rows loads the environment variables "into the script"

SILVA_trained_db=/media/matteo/SSD1/reference/SILVA_138_V3V4_BayesClassifier.qza
MIDAS_trained_db=/media/matteo/SSD1/reference/MIDAS_v5_3_Bayes_classifier_QIIME2.qza
...
qiime dada2 denoise-paired --i-demultiplexed-seqs trimmed-seqs.qza --p-trim-left-f 0 --p-trim-left-r 0 --p-trunc-len-f 275 --p-trunc-len-r 171 --o-table table.qza --o-representative-sequences rep-seqs.qza --o-denoising-stats denoising-stats.qza --p-n-threads $threads
