...
qiime dada2 denoise-paired --i-demultiplexed-seqs trimmed-seqs.qza --p-trim-left-f 0 --p-trim-left-r 0 --p-trunc-len-f 276 --p-trunc-len-r 169 --o-table table.qza --o-representative-sequences rep-seqs.qza --o-denoising-stats denoising-stats.qza --p-n-threads 8
...
ID <-read.table(file="../../Metadata.tsv", sep="\t", header=T)
row.names(ID)<- ID$FASTQ_Code # the actual names of the samples
