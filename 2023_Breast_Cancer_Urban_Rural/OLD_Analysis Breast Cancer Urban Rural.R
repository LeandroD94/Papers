...
ggsave(file="Results/H_vs_Cancer/Abundances/TOP5_phyla_abundances.png",width=7,height=8, dpi=300) 
dev.off()
...
ggsave(file="Results/H_vs_Cancer/Abundances/TOP8_genera_abundances.png",width=7,height=8, dpi=300) 
dev.off()
...
plot_ordination(data.sqrt_prop, ordBC, color = "Tissue") +
  ...
  labs(title="PCoA with Hellinger distance\n (euclidean on Hellinger transformed genera)", color="Tissue", 
       x=paste("PC1: ",eigval[1],"% variation"), y=paste("PC2: ",eigval[2],"% variation"),
       caption="lines connect paired samples")
ggsave(file="Results/H_vs_Cancer/Beta_div/PCoA_Beta_diversity_Hellinger_on_genera_points.png", width = 6.5, height = 5, dpi=300)
...
ggsave(filename = "Results/H_vs_Cancer/Beta_div/Venn_Diagramm.png", width = 4, height = 4, dpi=300, bg = "white")
dev.off()
...
ggsave(file="Results/Radiotherapy_ONLY_cancer_tissue/TOP_5_phyla.png",width=7,height=5, dpi=300)
dev.off()
...
ggplot(data=tabella, aes(x=ID, y=Abundance, fill=Phylum)) +
  ...
  theme(legend.position="bottom") + guides(fill=guide_legend(nrow=2)) +
  labs(x="Patients", y="Relative abundance", title = "Five most abundant phyla (only Cancer Tissues)", caption = " 'Others' includes every phylum below rank 5 ")
ggsave(file="Results/Chemotherapy_ONLY_cancer_tissue/TOP_5_phyla.png",width=7,height=5, dpi=300)
dev.off()
...
ggplot(data=tabella, aes(x=ID, y=Abundance, fill=Genus)) + facet_grid(cols= vars(Chemotherapy),scales = "free_x", space = "free_x") +
  ...
  theme(legend.position="bottom", legend.margin = margin(3,0,0,0)) + guides(fill=guide_legend(nrow=3)) + 
  labs(x="Patients", y="Relative abundance", title = "Eigth most abundant genera (only Cancer Tissues)", caption = " 'Others' includes every genus below rank 8 ")
ggsave(file="Results/Chemotherapy_ONLY_cancer_tissue/TOP_8_genera.png",width=7,height=5,dpi=300)
dev.off()
...
ggplot(data=tabella, aes(x=ID, y=Abundance, fill=Phylum)) +
  ...
  theme(legend.position="bottom") + guides(fill=guide_legend(nrow=2)) +
  labs(x="Patients", y="Relative abundance", title = "Five most abundant phyla (only Cancer Tissues)", caption = " 'Others' includes every phylum below rank 5 ")
ggsave(file="Results/City_ONLY_cancer_tissue/Abundances/TOP_5_phyla.png",width=7,height=5, dpi=300)
dev.off()
...
ggplot(data=tabella, aes(x=ID, y=Abundance, fill=Genus)) + facet_grid(cols= vars(City),scales = "free_x", space = "free_x") +
  ...
  theme(legend.position="bottom", legend.margin = margin(3,0,0,0)) + guides(fill=guide_legend(nrow=3)) +
  labs(x="Patients", y="Relative abundance", title = "Eigth most abundant genera (only Cancer Tissues)", caption = " 'Others' includes every genus below rank 8 ")
ggsave(file="Results/City_ONLY_cancer_tissue/Abundances/TOP_8_genera.png",width=7,height=5,dpi=300)
dev.off()
...
ggsave(file="Results/City_ONLY_cancer_tissue/Beta_div/PCoA_Beta_diversity_Hellinger_on_genera_POINT.png", width = 6.5, height = 5, dpi=300)
# without ellipses
plot_ordination(data.sqrt_prop, ordBC, color = "City") +
  scale_color_manual(values=c("Urban"="royalblue","Rural"="coral2")) +
  geom_point(size=3.2, alpha=1, shape=16) + geom_point(size=4.5, alpha=0.65) +
...
ggsave(filename = "Results/City_ONLY_cancer_tissue/Beta_div/Venn_Diagramm.png", width = 4, height = 4, dpi=300, bg = "white")
dev.off()
...
ggplot(Table_tot, aes(x= Bacteria, y=Abundance, fill=City)) +
  ...
  labs(title= "Differently abundant Taxa (Cancer Tissue)", y="Percent Abundance",
       fill="City group", x="")
ggsave(filename = "Results/City_ONLY_cancer_tissue/DA_DESeq2/DA_City_Cancer_Tissue_BOXPLOT.png", width = 7, height = 5, dpi=300)
dev.off()
...
ggplot(Table_tot, aes(x= Bacteria, y=Abundance, color=City, fill=City)) +
  ...
  labs(title= "Differently abundant Taxa (Cancer Tissue)", y="Percent Abundance",
       fill="City group", x="") +
  guides(fill="none")
ggsave(filename = "Results/City_ONLY_cancer_tissue/DA_DESeq2/DA_City_Cancer_Tissue_BOXPLOT2.png", width = 7, height = 5, dpi=300)
dev.off()
...
ggsave(file="Results/City_ONLY_Healthy_tissue/Abundances/TOP_5_phyla.png",width=7,height=5, dpi=300)
dev.off()
...
ggsave(file="Results/City_ONLY_Healthy_tissue/Abundances/TOP_8_genera.png",width=7,height=5,dpi=300)
dev.off()
